...
public class WrapperFunctions
{
	...
	public WrapperFunctions(StepBase objStepBase, AngularHandle objAngularHandle)
	{
	...
	*/
	...
	public String getText(By objLocator, String sTextBy) 
	{
		try
		{
			...
			WebElement objWebElement = objStepBase.getDriver().findElement(objLocator);
			String sText = "";
			//RSHANK15 - 27SEP2017 Modified - Replaced sValue by Value 
			if(sTextBy.equalsIgnoreCase("Value"))
				sText = objWebElement.getAttribute("value");
